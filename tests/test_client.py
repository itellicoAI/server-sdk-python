...
class TestItellicoai:
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = Itellicoai(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Itellicoai) -> None:
        respx_mock.get("/v1/accounts/me").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Itellicoai) -> None:
        respx_mock.get("/v1/accounts/me").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/v1/accounts/me").mock(side_effect=retry_handler)
...
class TestAsyncItellicoai:
    ...
    def test_base_url_trailing_slash(self, client: AsyncItellicoai) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncItellicoai) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncItellicoai) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncItellicoai(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_get_platform(self) -> None:
        ...
        from itellicoai._base_client import get_platform
